...
from django.utils.translation import gettext, gettext_lazy as gettexttt
...
class UserLogin(AuthenticationForm):
    ...
    password=forms.CharField(label=gettexttt("Password") ,widget=forms.PasswordInput(attrs={'autocomplete':'current-password','class':'form-control'}))
